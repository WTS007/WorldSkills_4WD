...
public class DriveBase extends SubsystemBase
{
    ...
    public DriveBase ()
    {
        ...
        backMotor = new TitanQuad(Constants.TITAN_ID, Constants.M3);
        ...
        backEncoder = new TitanQuadEncoder(backMotor, Constants.M3, Constants.WHEEL_DIST_PER_TICK);
